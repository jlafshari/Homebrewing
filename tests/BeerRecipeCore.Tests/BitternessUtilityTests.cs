...
namespace BeerRecipeCore.Tests
{
    ...
    public class BitternessUtilityTests
    {
        ...
        public void GetBitternessTest()
        {
            ...
            HopsIngredient fugglesInRecipe = new HopsIngredient(fuggles) { Amount = 1f, Form = HopsForm.Leaf, FlavorType = HopsFlavorType.Bittering, Time = 60 };
            
            Hops goldings = new Hops("Goldings", new HopsCharacteristics(5.00f, 3.50f), "Boil", "Test Notes", "UK");
            HopsIngredient goldingsInRecipe = new HopsIngredient(goldings) { Amount = 1f, Form = HopsForm.Pellet, FlavorType = HopsFlavorType.Aroma, Time = 15 };
